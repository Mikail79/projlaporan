            ...
            <div class="row d-flex align-items-center justify-content-center h-100">
                <div class="container d-flex flex-row justify-content-evenly align-items-center">
                    <div class="col-md-8 col-lg-7 col-xl-6 d-flex justify-content-center">
                        <img src="https://smkn4bogor.sch.id/assets/images/logo/logoSMKN4.svg" alt="" class="img-fluid" style="height:300px" >
                    </div>
                    <div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1">
                        <main class="form-login card p-5 rounded shadow-lg">
